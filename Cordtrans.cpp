...
CString CCordtrans::Differencebetween(CCrdNum crd1, CCrdNum crd2)//?????λ???
{
	CString txt0="\n";
	...
	{
		AfxMessageBox("????????????е??????????",MB_OK|MB_ICONINFORMATION);
		txt0=txt0+"????????"+"\n";
